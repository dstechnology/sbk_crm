...
cur_frm.add_custom_button(__('Add Meeting Details'), function(doc, cdt, cdn, cmnt) {
   var d = frappe.prompt([
    ...
    {'fieldname': 'remarks', 'fieldtype': 'Text', 'label': 'Remarks', 'reqd': 0},
    ...
    {'fieldname': 'comment', 'fieldtype': 'Text', 'label': 'Next Action Task', 'reqd': 0},
    ...
    {'fieldname': 'expense_date', 'fieldtype': 'Date', 
                'label': 'Expense Date', 'default': frappe.datetime.add_days(frappe.datetime.nowdate(),0), 'reqd': 0,depends_on:'is_expense'},
